...
public:
   ...
   */
  pandora::StatusCode CreateTrackToMCParticleRelationships(const EVENT::LCEvent* const pLCEvent,
   ...
   */
  pandora::StatusCode CreateCaloHitToMCParticleRelationships(const EVENT::LCEvent* const pLCEvent,
