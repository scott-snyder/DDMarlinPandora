...
public:
  ...
  public:
    ...
    FloatVector m_ecalInputEnergyCorrectionPoints{}; ///< The input energy points for non-linearity energy correction in
                                                     ///< the ECAL
    FloatVector m_ecalOutputEnergyCorrectionPoints{}; ///< The input energy points for non-linearity energy correction
                                                      ///< in the ECAL
...
// Added by T.Pasquier
/**
 *  @brief  Register the LCContent plugins outside their original function. Temporary fix. Would be better to change the
 * plugins registration directly in LCContent
 */
