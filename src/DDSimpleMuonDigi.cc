...
DDSimpleMuonDigi::DDSimpleMuonDigi() : Processor("DDSimpleMuonDigi") {
  ...
  registerProcessorParameter("MuonTimeThreshold", "Energy threshold for timing information for Muon Hits in GeV",
                             _timeThresholdMuon, (float)0.025);
  ...
  registerProcessorParameter("DetectorNameBarrel", "Name of the barrel subdetector", _detectorNameBarrel,
                             std::string("YokeBarrel"));

  registerProcessorParameter("DetectorNameEndcap", "Name of the endcap subdetector", _detectorNameEndcap,
