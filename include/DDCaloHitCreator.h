...
protected:
   ...
   */
  virtual void GetCommonCaloHitProperties(const EVENT::CalorimeterHit* const pCaloHit,
  ...
  // Added by T.Pasquier
  std::unique_ptr<pandora::ObjectFactory<object_creation::CaloHit::Parameters, object_creation::CaloHit::Object>>
      m_caloHitFactory{nullptr}; // General factory to initialize
};
